        ...
        <div class="col-lg-12">
            ...
            //		'enableAjaxValidation' => 'true'
             ...
             <div class="panel-heading">
                        <h3 class="panel-title pull-left">Utwórz klienta </h3>
                        
                        <div class="clearfix"></div>
                    </div>
				<?= $form->field($customer, 'customerName') ?>
                <?= $form->field($customer, 'customerSurname') ?>
                <?= $form->field($customer, 'customerStreet') ?>
                <?= $form->field($customer, 'customerPostcode') ?>
                <?= $form->field($customer, 'customerCity') ?>
                <?= $form->field($customer, 'customerPESEL') ?>
                <?= $form->field($customer, 'customerPhone') ?>
                <?= $form->field($customer, "customerBirthdate")->widget(DatePicker::className(),[
                		'language' => 'pl',
                		'dateFormat' => 'yyyy-MM-dd',
                		'options'=>['class'=>'form-control dp']
			    ]);
             ?>
                <?= $form->field($reservation, 'reservationPrepaid') ?>
