	...
	public function rules()
	{
		return [
				[['ContractorShortName', 'ContractorFullName', 'ContractorStreet',
				  'ContractorPostcode', 'ContractorCity', 'ContractorNIP'], 
				 'required', 'message' => 'To pole nie może być puste.'],
				[['ContractorNIP'], 'integer', 'message' => 'Dozwolone znaki to cyfry.'],
				[['ContractorShortName', 'ContractorStreet','ContractorCity'], 'string', 'max' => 45, 'message' => "Za długa wartość. Maksymalna długość: 45 znaków."],
